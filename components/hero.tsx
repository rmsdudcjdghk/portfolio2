...
export function Hero() {
  ...
  // 초기 데이터 - 배열 형태로 변경
  const defaultSocialLinks = [{"name":"새 링크","icon":"instagram","url":"https://www.instagram.com/acaeei?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==&igsi=ZDNlZDc0MzIxNw=="},{"name":"새 링크","icon":"globe","url":"https://blog.naver.com/kamuifor"},{"name":"새 링크","icon":"globe","url":"https://www.st-news.co.kr/news/articleList.html?sc_area=I&sc_word=aliceoh"}]
